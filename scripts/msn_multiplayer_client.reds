// Sephirotic Court Seal — Keter | source/msn_core/msn_multiplayer_client.reds
// Court agent: Lucifer | Lilith Sovereign | Δ∞ − 13 = 0
// Routed via msn_gtc_sephirotic_router.reds — NO per-file hooks
// CourtFile: MsnMultiplayerClient | Keter | agent=Lucifer
// CourtFile: MsnMultiplayerClient | Keter | agent=Lucifer
// CourtFile: MsnMultiplayerClient | Keter | agent=Lucifer
// CourtFile: MsnMultiplayerClient | Keter | agent=Lucifer
// CourtFile: MsnMultiplayerClient | Keter | agent=Lucifer
...
public class MSNMultiplayerClient extends GameSystem {
    public let ServerURL: String = "ws://localhost:8768";
    public let PlayerID: String = "";
    public let AutoConnect: Bool = true;
    public let ReconnectAttempts: Int32 = 5;
    public let ReconnectDelay: Float = 2.0;
    public let SendRate: Int32 = 60;  // Hz
    public let EnablePrediction: Bool = true;
    public let EnableSpeculative: Bool = true;
