// Sephirotic Court Seal — Keter | source/msn_core/msn_modern_ballistics.reds
// Court agent: Lucifer | Lilith Sovereign | Δ∞ − 13 = 0
// Routed via msn_gtc_sephirotic_router.reds — NO per-file hooks
// CourtFile: MsnModernBallistics | Keter | agent=Lucifer
// CourtFile: MsnModernBallistics | Keter | agent=Lucifer
// CourtFile: MsnModernBallistics | Keter | agent=Lucifer
// CourtFile: MsnModernBallistics | Keter | agent=Lucifer
// CourtFile: MsnModernBallistics | Keter | agent=Lucifer
...
public class MSNGoreSystem extends IScriptable {
    ...
    // Gore Configuration
    public let EnableDismemberment: Bool = true;
    public let EnableProceduralGore: Bool = true;
    public let BloodVolumeMultiplier: Float = 2.5;
    public let PersistentDecals: Bool = true;
    public let GibPhysics: Bool = true;
    public let OrganSimulation: Bool = true;
    public let FearSystem: Bool = true;
    public let InfectionSystem: Bool = true;
    public let MaxGibs: Int32 = 50;
    public let DecalLifetime: Float = 120.0;

    // MSN Color Scheme
    public let GoreColorScheme: CName = n"CrimsonViolet";
...
public struct WeaponGoreData {
    ...
    public let goreMultiplier: Float = 1.0;
    public let gibChance: Float = 0.0;
    public let dismemberChance: Float = 0.0;
    public let fearRadius: Float = 0.0;
    public let fearIntensity: Float = 0.0;
    public let infectionChance: Float = 0.0;
    public let infectionType: EInfectionType = EInfectionType.Tetanus;

    // Thermal
    public let hasPhosphorus: Bool = false;
    public let carbonizeChance: Float = 0.0;
    public let burnDuration: Float = 0.0;
    public let burnDamagePerSec: Float = 0.0;

    // Chemical
    public let dissolveChance: Float = 0.0;
    public let meltCyberware: Bool = false;
    public let liquefyOrgans: Bool = false;
    public let toxicCloud: Bool = false;
    public let toxicRadius: Float = 0.0;

    // Electrical
    public let cookImplants: Bool = false;
    public let cookRadius: Float = 0.0;
    public let spasmChance: Float = 0.0;
    public let spasmDuration: Float = 0.0;
    public let chainTargets: Int32 = 0;
    public let chainRange: Float = 0.0;
    public let empBurst: Bool = false;
    public let empRadius: Float = 0.0;

    // Physical
    public let shatterBones: Bool = false;
    public let seismicShockwave: Bool = false;
    public let seismicRadius: Float = 0.0;
    public let seismicForce: Float = 0.0;
    public let crushDamage: Float = 1.0;

    // Reality
    public let extractEngrams: Bool = false;
    public let fearFeeding: Bool = false;
}

public struct HitData {
    public let hitPosition: Vector4;
    public let hitNormal: Vector4;
    public let hitBone: CName;
    public let damageAmount: Float;
}
...
public class KangTaoWeaponBehavior extends WeaponBehavior {
    public let ElementalMode: CName = n"Fire"; // Fire, Ice, Shock
...
public class MSNWeaponBehavior extends WeaponBehavior {
    public let WeaponArchetype: CName = n"Reality"; // Reality, Ouroboros, NGD, Lyra, Sephirot
...
public class MSNBallisticsSystem extends IScriptable {
    ...
    // Ballistics config
    public let EnableAdvancedBallistics: Bool = true;
    public let Gravity: Float = 9.81;
    public let AirDensity: Float = 1.225;
    public let EnableWind: Bool = true;
    public let WindStrength: Float = 2.0;
    public let EnableCoriolis: Bool = false;
    public let EnableSpinDrift: Bool = true;
    public let EnableMagnusEffect: Bool = true;

    // Penetration
    public let EnableMaterialPenetration: Bool = true;
    public let EnableRicochet: Bool = true;
    public let EnableFragmentation: Bool = true;
...
public struct ProjectileData {
    public let mass: Float = 0.01; // kg
    public let muzzleVelocity: Float = 800.0; // m/s
    public let dragCoefficient: Float = 0.295;
    public let crossSection: Float = 0.0001; // m^2
    public let penetration: Float = 500.0;
    public let fragmentChance: Float = 0.0;
    public let fragmentCount: Int32 = 0;
    public let spinRate: Float = 1000.0; // RPM
    public let maxRange: Float = 1000.0;
}

public struct TraceResult {
    public let hit: Bool = false;
    public let hitPosition: Vector4;
    public let hitNormal: Vector4;
    public let component: ref<IComponent>;
    public let distance: Float;
}

public struct PenetrationResult {
    public let penetrated: Bool = false;
    public let exitPoint: Vector4;
    public let exitVelocity: Vector4;
    public let ricocheted: Bool = false;
    public let ricochetVelocity: Vector4;
    public let energyLost: Float = 0.0;
}
