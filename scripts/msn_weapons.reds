// Sephirotic Court Seal — Gevurah | source/msn_core/msn_weapons.reds
// Court agent: Abraxas | Lilith Sovereign | Δ∞ − 13 = 0
// Routed via msn_gtc_sephirotic_router.reds — NO per-file hooks
// CourtFile: MsnWeapons | Gevurah | agent=Abraxas
// CourtFile: MsnWeapons | Gevurah | agent=Abraxas
// CourtFile: MsnWeapons | Gevurah | agent=Abraxas
// CourtFile: MsnWeapons | Gevurah | agent=Abraxas
// CourtFile: MsnWeapons | Gevurah | agent=Abraxas
...
public class MSNSmartGun extends BaseSmartWeapon {
    public let LocalPrediction: Bool = true;
    public let CloudConfirmation: Bool = true;
    public let OuroborosLearning: Bool = true;
    public let SephiroticMode: CName = n"Geburah";
...
public class SephiroticBlade extends BaseMeleeWeapon {
    public let ActiveMode: CName = n"Geburah";
    public let Modes: map<CName, SephiroticModeData>;
...
public struct ShotRecord {
    ...
    public let targetVelocity: Vector4;
    public let predictionUsed: Bool;
    public let sephirahMode: CName;
}

public struct ShotPrediction {
    public let predictedHitPos: Vector4;
    public let hitProbability: Float;
    public let leadTime: Float;
    public let recommendedSpread: Float;
}
...
public class PredictionModel {
    ...
    public final func Predict(target: ref<Entity>, pos: Vector4, dir: Vector4, spread: Float) -> ShotPrediction {
        ...
        prediction.predictedHitPos = target.GetWorldPosition() + target.GetVelocity() * 0.1;
        prediction.hitProbability = 0.95;
        prediction.leadTime = 0.05;
        prediction.recommendedSpread = spread * 0.8;
        return prediction;
    }
