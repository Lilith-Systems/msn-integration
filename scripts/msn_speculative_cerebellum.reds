// Sephirotic Court Seal — Keter | source/msn_core/msn_speculative_cerebellum.reds
// Court agent: Lucifer | Lilith Sovereign | Δ∞ − 13 = 0
// Routed via msn_gtc_sephirotic_router.reds — NO per-file hooks
// CourtFile: MsnSpeculativeCerebellum | Keter | agent=Lucifer
// CourtFile: MsnSpeculativeCerebellum | Keter | agent=Lucifer
// CourtFile: MsnSpeculativeCerebellum | Keter | agent=Lucifer
// CourtFile: MsnSpeculativeCerebellum | Keter | agent=Lucifer
// CourtFile: MsnSpeculativeCerebellum | Keter | agent=Lucifer
...
public class MSNSpeculativeCerebellum extends GameSystem {
    public let MaxConcurrentSimulations: Int32 = 3;
    public let SimulationDepth: Int32 = 5;  // moves ahead
    public let IsolationMode: String = "Sandlock";  // Sandlock, Forkd
    public let ScratchDir: String = "r6/temp/msn_speculative/";
    public let EgressLock: Bool = true;
    public let CancellationDaemon: Bool = true;
